...
Si bien éste proyecto puede adaptarse a las diferentes necesidades y solitudes de nuestros clientes, lo cierto es que el mismo **no ha sido creado a requerimiento de un cliente en particular**; por lo que, naturalmente, el análisis descansa muchas veces en cuestiones generales o ejemplificaciones de las zonas de mayor interés. Debe dejarse debidamente asentado que, ante el requerimiento expreso de los interesados, el análisis y los productos que forman parte del proyecto (como el Dashboard o el Sistema de Recomendación) pueden direccionarse o modificarse en gran medida, para hacerlo adaptable a las nuevas necesidades.
